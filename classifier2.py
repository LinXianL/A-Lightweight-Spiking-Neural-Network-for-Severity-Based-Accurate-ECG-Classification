...
from models import SNN_2
from trainer import train_one_epoch,evaluate
def main():

    args = get_args('class2')
    ...
    new_state_dict = {
        ...
        'layer.3.weight': pretrained_dict['task_heads.1.0.weight'],
        'layer.5.weight': pretrained_dict['task_heads.1.2.weight'],
    }
    ...
    train_dataset_path = "./DATASET/320dataset/dataset2/train_data2(320).csv"
    test_dataset_path = "./DATASET/320dataset/dataset2/test_data2(320).csv"
    ...
    for epoch in range(start_epoch, args.epochs):
       #训练
        train_loss, train_acc, train_class_acc = train_one_epoch(model, train_data_loader, optimizer, encoder, args.device, args.T, scaler=scaler, num_classes=6)
        # 测试
        test_loss, test_acc, test_class_acc = evaluate(model, test_data_loader, encoder, args.device, args.T, num_classes=6)
