...
from models import SNN_1
from trainer import train_one_epoch,evaluate
def main():

    args = get_args('class1')
    ...
    new_state_dict = {
        ...
        'layer.3.weight': pretrained_dict['task_heads.0.0.weight'],
        'layer.5.weight': pretrained_dict['task_heads.0.2.weight'],
    }
    ...
    train_dataset_path = "./DATASET/320dataset/dataset_1/train_data1(320,3).csv"
    test_dataset_path = "./DATASET/320dataset/dataset_1/test_data1(320,3).csv"
    ...
    for epoch in range(start_epoch, args.epochs):
       #训练
        train_loss, train_acc, train_class_acc = train_one_epoch(model, train_data_loader, optimizer, encoder, args.device, args.T, scaler=scaler, num_classes=3)
        # 测试
        test_loss, test_acc, test_class_acc = evaluate(model, test_data_loader, encoder, args.device, args.T, num_classes=3)
